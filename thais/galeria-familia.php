...
rsort($files); // muestra primero lo "más nuevo" por nombre
?>
<!doctype html>
<html lang="es">
<head>
  ...
  <title>Galería · Familia · Thais Esteve</title>
...
<header>
  <div class="container topbar">
    ...
    <nav>
      ...
      <a href="galeria-familia.php" class="nav-cta">Familia</a>
      <a href="galeria-naturaleza.php">Naturaleza</a>
    </nav>
  </div>
</header>
...
<main>
  <section>
    <div class="container">
      <h1>Galería · Familia y personas</h1>
      <p>Haz clic en una foto para verla grande.</p>
      <a class="btn btn-primary" href="index.html#familia">Volver</a>

      <div class="galeria" aria-label="Galería completa de familia">
